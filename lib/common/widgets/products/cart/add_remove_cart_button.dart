...
class KProductQuantityWithAddRemoveButton extends StatelessWidget {
  const KProductQuantityWithAddRemoveButton({
    ...
    this.addBackgroundColor = KColors.black,
    this.removeBackgroundColor = KColors.darkGrey,
    this.addForegroundColor = KColors.white,
    this.removeForegroundColor = KColors.white,
  });
