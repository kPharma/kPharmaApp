...
class FavouritesController extends GetxController {
  ...
  Future<void> initFavorites() async {
    final json = KLocalStorage.instance().readData('favorites');
    if (json != null) {
  ...
  Future<void> toggleFavoriteProduct(String productId) async {
    ...
    if (!favorites.containsKey(productId)) {
      ...
      KLoaders.customToast(message: 'Product has been added to the Wishlist.');
    } else {
      KLocalStorage.instance().removeData(productId);
  ...
  Future<void> saveFavoritesToStorage() async {
    ...
    KLocalStorage.instance().writeData('favorites', encodedFavorites);
  }
