...
class CartController extends GetxController {
  ...
  void addToCart(ProductModel product) {
    if (productQuantityInCart.value < 1) {
      KLoaders.customToast(message: 'Select Quantity');
      return;
    }

    if (product.productType == ProductType.variable.toString() &&
        variationController.selectedVariation.value.id.isEmpty) {
      KLoaders.customToast(message: 'Select Variation');
      return;
    }
    ...
    updateCart();
    KLoaders.customToast(message: 'Your Product has been added to the Cart.');
  }
  ...
  void removeFromCartDialog(int index) {
    Get.defaultDialog(
      ...
      onConfirm: () {
        ...
        cartItems.removeAt(index);
        updateCart();
        KLoaders.customToast(message: 'Product removed from the Cart.');
        Get.back();
      },
      onCancel: () => () => Get.back(),
    );
  ...
  void loadCartItems() async {
    final cartItemStrings =
        KLocalStorage.instance().readData<List<dynamic>>('cartItems');
  ...
  void saveCartItems() {
    ...
    KLocalStorage.instance().writeData('cartItems', cartItemStrings);
  }
