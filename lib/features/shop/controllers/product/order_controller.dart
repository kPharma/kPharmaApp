import 'package:kPharma/common/widgets/success_screen/success_screen.dart';
  ...
  void processOrder(double totalAmount) async {
    try {
      ...
      KFullScreenLoader.openLoadingDialog(
          'Processing your order', KImages.pencilAnimation);
      ...
      Get.off(() => SuccessScreen(
            image: KImages.orderCompletedAnimation,
